    ...
    <header className="sticky top-0 z-50 border-b bg-white/70 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-base font-semibold tracking-tight">Savartan</span>
        </Link>
      ...
      <div className="border-t bg-white md:hidden">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2">
          <Link href="/pets" className="text-sm text-muted-foreground">Pets</Link>
          <Link href="/about" className="text-sm text-muted-foreground">About</Link>
          <Link href="/how-it-works" className="text-sm text-muted-foreground">How</Link>
